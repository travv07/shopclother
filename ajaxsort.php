<?php 
	...
	if(isset($_GET['price'])){
		$value = $_GET['price'];
		if($value=='cao'){
			$sql = "SELECT * from Products as p JOIN Categorys as c on c.id_category=p.id_category ORDER BY p.price DESC";
		}else if($value='thap'){
			$sql = "SELECT * from Products as p JOIN Categorys as c on c.id_category=p.id_category ORDER BY p.price ASC";
		}
		else 
			$sql = "SELECT * from Products as p JOIN Categorys as c on c.id_category=p.id_category";
