<?php 
	...
	if(isset($_GET['value'])){
		$value = $_GET['value'];
		$sql = "SELECT * from Products as p join Productimage as pi on p.id_product_img=pi.id_product_img JOIN Categorys as c on c.id_category=p.id_category where p.name LIKE  '%$value%' ";
